...
| `unified-error-envelope-complete` | #196 | Complete migration: all controllers → envelope, `NotFoundException`, 14 codes, full frontend i18n | **In progress** — OpenSpec `unified-error-envelope-complete` |
