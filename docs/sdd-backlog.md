...
| `typed-yaml-kuadrant` | #262 | Phase 3 (largest) — AuthPolicy (+10 contributors), RateLimitPolicy, TLS/DNSPolicy, APIProduct, ApiKey → Java records | **Archived** — OpenSpec `2026-09-01-typed-yaml-kuadrant`; PR [#266](https://github.com/Everything-is-Code/migration-toolkit-rhcl/pull/266) |
| `typed-yaml-httproute` | #262 | Phase 4 (recommended last) — HTTPRoute + 8 contributors + 3 support → Fabric8 Gateway API model | **Archived** — OpenSpec `2026-09-01-typed-yaml-httproute`; PR [#267](https://github.com/Everything-is-Code/migration-toolkit-rhcl/pull/267) |
